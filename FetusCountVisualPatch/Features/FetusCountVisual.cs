...
internal static class FetusCountVisual
{
    public static void Inject()
    {
        ...
        for (int i = 0; i < list.Count; i++)
        {
            ...
            Traverse.Create(fetus_4.GetComponent<ReferenceCharacterStatePlate>())
                .Field("m_DataType").SetValue(ReferenceCharacterStatePlatePatch.EDataType_Fetus4);

            var sprite_fetus_4 = fetus_4.transform.GetChild(0).gameObject;
            sprite_fetus_4.name = "slaveui_icon_fetus_4";
            sprite_fetus_4.GetComponent<SpriteRenderer>().sprite = FetusSprite.SpriteFetus4;
            #endregion
            ...
            Traverse.Create(fetus_5.GetComponent<ReferenceCharacterStatePlate>())
                .Field("m_DataType").SetValue(ReferenceCharacterStatePlatePatch.EDataType_Fetus5);

            var sprite_fetus_5 = fetus_5.transform.GetChild(0).gameObject;
            sprite_fetus_5.name = "slaveui_icon_fetus_5";
            sprite_fetus_5.GetComponent<SpriteRenderer>().sprite = FetusSprite.SpriteFetus5;
            #endregion

        }
        ModEntry.Log("FetusCountVisual injected");
    }
}